/* Auto-generated by genmsg_cpp for file /home/ttremblay/groovy_workspace/sandbox/EposManager/msg/MotorInfo.msg */
...
struct MotorInfo_ {
  ...
  , motor_position(0)
  , motor_current(0)
  , digital_input_3_state(0)
  , digital_input_4_state(0)
  , stamp()
  {
  }
  ...
  typedef uint8_t _digital_input_3_state_type;
  uint8_t digital_input_3_state;

  typedef uint8_t _digital_input_4_state_type;
  uint8_t digital_input_4_state;
...
struct MD5Sum< ::EposManager::MotorInfo_<ContainerAllocator> > {
  ...
  {
    return "a222161cf8293a6ca68af3a23682c436";
  }

  static const char* value(const  ::EposManager::MotorInfo_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xa222161cf8293a6cULL;
  static const uint64_t static_value2 = 0xa68af3a23682c436ULL;
};
...
template<class ContainerAllocator> struct Serializer< ::EposManager::MotorInfo_<ContainerAllocator> >
{
  template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
  {
    ...
    stream.next(m.digital_input_3_state);
    stream.next(m.digital_input_4_state);
    stream.next(m.stamp);
  }
...
struct Printer< ::EposManager::MotorInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::EposManager::MotorInfo_<ContainerAllocator> & v) 
  {
    ...
    s << indent << "digital_input_3_state: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.digital_input_3_state);
    s << indent << "digital_input_4_state: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.digital_input_4_state);
    s << indent << "stamp: ";
