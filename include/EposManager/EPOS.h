...
public:
	...
	/**
	 * Sets all digital outputs to the same state.
	 *
	 * @param state The state to set the digital outputs to.  True = high, False = low.
	 * @return A boolean indicating whether or not the command succeeded.
	 */
	bool setAllDigitalOutputs(bool state);

        /**
         * Gets all digital outputs for the controller.
         *
         * @param outputs the states of the digital inputs on the controller.
         * @return A boolean indicating whether or not the command succeeded.
         */
        bool getAllDigitalInputs(unsigned short* inputs);
