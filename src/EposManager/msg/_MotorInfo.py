...
class MotorInfo(genpy.Message):
  _md5sum = "a222161cf8293a6ca68af3a23682c436"
...
"""
  __slots__ = ['node_id','motor_name','state','faults','motor_velocity','motor_position','motor_current','digital_input_3_state','digital_input_4_state','stamp']
  _slot_types = ['uint16','string','uint16','string','int32','int32','int32','uint8','uint8','time']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       node_id,motor_name,state,faults,motor_velocity,motor_position,motor_current,digital_input_3_state,digital_input_4_state,stamp
    ...
    if args or kwds:
      ...
      if self.digital_input_3_state is None:
        self.digital_input_3_state = 0
      if self.digital_input_4_state is None:
        self.digital_input_4_state = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3i2B2I.pack(_x.motor_velocity, _x.motor_position, _x.motor_current, _x.digital_input_3_state, _x.digital_input_4_state, _x.stamp.secs, _x.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.motor_velocity, _x.motor_position, _x.motor_current, _x.digital_input_3_state, _x.digital_input_4_state, _x.stamp.secs, _x.stamp.nsecs,) = _struct_3i2B2I.unpack(str[start:end])
      self.stamp.canon()
      return self
...
_struct_3i2B2I = struct.Struct("<3i2B2I")
